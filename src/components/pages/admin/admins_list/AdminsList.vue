    ...
    <div class="dashboard_body">
        ...
        >
            <template v-slot:tbody="{ record, index }">
                ...
                <td>
                    <span class="p-1 px-2 text-xs rounded-md bg-emerald-100 text-emerald-700" v-if="record.status == 'active'">Active</span>
                    <span class="p-1 px-2 text-xs rounded-md bg-rose-100 text-rose-700" v-if="record.status == 'deactive'">Deactive</span>
                </td>
