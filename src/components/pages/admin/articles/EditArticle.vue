<template>
    <div class="dashboard_body max-w-screen-xl mx-auto shadow-2xl">
        <div class="flex gap-2 items-baseline">
            ...
            <i class="fas fa-chevron-right text-sm text-secondary-400"></i>
            <h1 class="text-2xl"><b>ویرایش مقاله</b></h1>
        </div>
        ...
        <div class="flex flex-wrap items-center gap-4">
            <button
                ...
                @click="edit()"
            >
                <b v-if="!editingArticle">ثبت تغییرات</b>
...
export default {
    ...
    async mounted() {
        ...
        this.tempAddr = this.$route.params.id;
    },
    methods: {
        ...
        async edit() {
            ...
            axios
                .put(`${this.getBaseUrl()}/api/v1/admin/articles`, formData)
                .then((response) => {
                    this.makeToast({ title: "Update Article", message: "Article has been updated successfully", type: "info" });
                })
                .catch((error) => {
                    console.log(error);
        ...
        async getArticle() {
            await axios
                .get(`${this.getBaseUrl()}/api/v1/admin/article/${this.$route.params.id}`)
                .then((response) => {
